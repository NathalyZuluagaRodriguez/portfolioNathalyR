...
export const FeatureSection = () => {
  return (
    <section className="flex justify-center bg-purple-50 py-16">
      <div className="max-w-7xl w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-6 md:px-12">
        <FeatureCard
